...
module Vision
  class << self
    def get_image_data(image_file)
      # # APIのURL作成
      # api_url = "https://vision.googleapis.com/v1/images:annotate?key=#{ENV['GOOGLE_PLATFORM_API_KEY']}"
      ...
      uri = URI.parse("https://vision.googleapis.com/v1/images:annotate?key=#{ENV['GOOGLE_PLATFORM_API_KEY']}")
